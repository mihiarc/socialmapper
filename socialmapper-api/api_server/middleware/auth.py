...
class APIKeyMiddleware:
    ...
    def __init__(self, app, api_keys: Optional[Set[str]] = None, enabled: bool = False):
        self.app = app
...
async def get_api_key(api_key: Optional[str] = api_key_header) -> Optional[str]:
    """
...
async def require_api_key(api_key: Optional[str] = api_key_header) -> str:
    """
