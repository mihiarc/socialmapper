...
from .panel_map import generate_paneled_census_map

# Folium imports removed - migrated to Plotly
from .plotly_map import generate_plotly_maps_for_variables
from .single_map import generate_isochrone_map, generate_map
    ...
    if use_plotly and _IN_STREAMLIT:
        ...
        return generate_plotly_maps_for_variables(
            ...
            **{
                ...
                if k in ["colorscale", "height", "width", "show_legend", "map_style"]
            },
        )
    ...
    if include_isochrone_only_map and isochrone_path is not None:
        ...
        isochrone_result = generate_isochrone_map(
            ...
            **{
                k: v
                for k, v in kwargs.items()
                if k in ["title", "basemap_provider", "figsize", "dpi"]
            },
        )
        ...
        for variable in normalized_variables:
            ...
            result = generate_map(
                ...
                **{
                    ...
                    for k, v in kwargs.items()
                    if k
                    in ["title", "colormap", "basemap_provider", "figsize", "dpi", "show_isochrone"]
                },
            )
            output_paths.append(result)
