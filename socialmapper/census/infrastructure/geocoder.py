...
class CensusGeocoder:
    ...
    def _create_session(self) -> requests.Session:
        ...
        session.headers.update({
            "User-Agent": "SocialMapper/1.0 (Census Geocoder)"
        })
...
class MockGeocoder:
    ...
    def __init__(self, config: Optional[ConfigurationProvider] = None, logger: Optional[logging.Logger] = None):
