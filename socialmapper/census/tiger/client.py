...
class TigerGeometryClient:
    ...
    def fetch_block_groups(
        ...
        """
        geography_level = GeographyLevel.BLOCK_GROUP if use_generalized else GeographyLevel.BLOCK_GROUP_DETAILED
    ...
    def _validate_query(self, query: GeometryQuery) -> None:
        ...
        if query.geography_level in [GeographyLevel.BLOCK_GROUP, GeographyLevel.BLOCK_GROUP_DETAILED]:
    ...
    def _build_query_params(
        self, query: GeometryQuery, endpoint: TigerEndpoint
    ) -> Dict[str, Any]:
    ...
    def _get_cached_result(self, cache_key: str) -> Optional[GeometryResult]:
