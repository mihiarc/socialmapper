...
class SQLiteRepository:
    ...
    def _init_schema(self) -> None:
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_census_variable ON census_data(variable_code)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_census_year ON census_data(year)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_neighbor_source ON neighbor_relationships(source_geoid)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_neighbor_target ON neighbor_relationships(neighbor_geoid)")
