...
Usage:
    ...
    from socialmapper.census_modern import get_census_system
    
    census = get_census_system()
    data = census.get_census_data(['B01003_001E'], ['37183'])
    
    # Advanced usage with custom configuration
    from socialmapper.census_modern import CensusSystemBuilder
...
class CensusSystemBuilder:
    ...
    def build(self) -> CensusSystem:
        ...
        block_group_service = BlockGroupService(config, api_client, cache, repository)
