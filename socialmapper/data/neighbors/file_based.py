...
class FileNeighborManager:
    ...
    def get_geography_from_point(
        self, lat: float, lon: float, use_cache: bool = True, cache_result: bool = True
    ...
    def _geocode_point_with_census_api(self, lat: float, lon: float) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            if (
                "2020 ZIP Code Tabulation Areas" in geographies
                and geographies["2020 ZIP Code Tabulation Areas"]
            ):
                zcta_info = geographies["2020 ZIP Code Tabulation Areas"][0]
                zcta_geoid = zcta_info.get("GEOID")
            elif (
                "ZIP Code Tabulation Areas" in geographies
                and geographies["ZIP Code Tabulation Areas"]
            ):
            ...
            logger.debug(
                f"Geocoded ({lat}, {lon}): State {state_fips}, County {county_fips}, BG {block_group_geoid}, ZCTA {zcta_geoid}"
            )
            return result
    ...
    def _get_default_state_neighbors(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "19": [
                ...
                "31",
                "46",
            ],  # Iowa: Illinois, Kansas, Michigan, Missouri, Nebraska, South Dakota
            "20": [
                "08",
                "19",
                "29",
            ...
            "21": [
                ...
                "47",
                "54",
            ],  # Kentucky: Illinois, Indiana, Michigan, Ohio, Tennessee, West Virginia
            ...
            "24": [
                ...
                "51",
                "54",
            ],  # Maryland: Delaware, DC, New Jersey, Pennsylvania, Virginia, West Virginia
            "25": [
                "09",
                "33",
                "36",
            ...
            "26": [
                ...
                "39",
                "55",
            ],  # Michigan: Illinois, Indiana, Iowa, Kentucky, Ohio, Wisconsin
            "27": [
                "19",
                "30",
                "38",
                "46",
                "55",
            ],  # Minnesota: Iowa, Montana, North Dakota, South Dakota, Wisconsin
            ...
            "29": [
                ...
                "40",
                "47",
            ],  # Missouri: Arkansas, Illinois, Iowa, Kansas, Nebraska, Oklahoma, Tennessee
            "30": [
                "16",
                "27",
                "38",
                "46",
                "56",
            ],  # Montana: Idaho, Minnesota, North Dakota, South Dakota, Wyoming
            "31": [
                "08",
                "19",
                "20",
            ...
            "35": [
                ...
                "48",
                "49",
            ],  # New Mexico: Arizona, Arkansas, Colorado, Oklahoma, Texas, Utah
            "36": [
                "09",
                "25",
                "34",
                    ...
                    if neighbor_distance > 1:
                        for level in range(2, neighbor_distance + 1):
                            ...
                            for neighbor_state, neighbor_county in neighbors:
                                next_neighbors = self.get_neighboring_counties(
                                    neighbor_state, neighbor_county
                                )
    ...
    def get_neighbor_statistics(self) -> Dict[str, int]:
        ...
        stats = {"state_neighbors": 0, "county_neighbors": 0, "cached_points": 0}
...
def get_counties_from_pois(
    pois: List[Dict[str, Any]], include_neighbors: bool = False, neighbor_distance: int = 1
) -> List[Tuple[str, str]]:
