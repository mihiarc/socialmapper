...
from ..api.result_types import Err, Error, ErrorType, Ok, Result
from .entities import EntityExtractor, ExtractedEntity
from .intents import IntentClassification, IntentClassifier
    ...
    async def process_natural_query(self, query: str) -> Result[NLQueryResult, Error]:
        ...
        try:
            ...
            return Err(Error(
                ...
                message=f"Failed to process natural language query: {e!s}",
                context={"query": query},
                cause=e
            ))
