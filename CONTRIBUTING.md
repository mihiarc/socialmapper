...
Thank you for your interest in contributing to SocialMapper! This document provides guidelines and instructions for contributing to the project.
...
SocialMapper is a Python toolkit for spatial analysis and demographic mapping. We welcome contributions of all kinds:
...
SocialMapper uses **Ruff** for linting and formatting (replaces Black and Flake8):
...
All functions, classes, and modules must use **NumPy-style docstrings**:
...
def example_function(param1, param2, optional_param=None):
    ...
    Extended description providing more context about the
...
- **`isochrone/`**: Isochrone generation with optimization
...
- **Issue Tracker**: https://github.com/mihiarc/socialmapper/issues
...
By contributing to SocialMapper, you agree that your contributions will be licensed under the MIT License.
