...
from socialmapper.geocoding import (
    geocode_address, geocode_addresses, AddressInput, 
    GeocodingConfig, AddressProvider, AddressQuality
)
from socialmapper.ui.console import console, print_banner, print_success, print_panel
    ...
    try:
        ...
        with SocialMapperClient() as client:
            ...
            if result.is_ok():
                ...
                console.print(f"✅ SocialMapper Analysis Complete!")
                ...
                if analysis.files_generated:
                    console.print(f"   📁 Results saved to output/tutorial_geocoding/")
            else:
