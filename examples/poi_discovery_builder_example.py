...
def main():
    ...
    print(f"   Travel time: 15 minutes")
    ...
    print(f"   Travel mode: Biking")
    print(f"   Categories: food_and_drink, healthcare, education")
    print(f"   Max POIs per category: 25")
    ...
    print(f"   Location: (37.7749, -122.4194) - San Francisco coordinates")
    print(f"   Travel time: 30 minutes")
    print(f"   Travel mode: Driving")
    print(f"   Excluded categories: utilities, services")
    print(f"   Exports: CSV and maps enabled")
    ...
    print(f"   OSM search: hospitals in Seattle, WA")
    print(f"   POI discovery: healthcare & education within 15 min")
    print(f"   Census variables: total_population, median_income")
