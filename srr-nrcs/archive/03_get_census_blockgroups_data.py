...
# Define the list of state FIPS codes to fetch data for
state_list = ['47','13','37']
...
if dfs:
    ...
    # Save to CSV
    final_df.to_csv('tables/block_groups_population.csv', index=False)
    print("Data saved to 'tables/block_groups_population.csv'")
else:
